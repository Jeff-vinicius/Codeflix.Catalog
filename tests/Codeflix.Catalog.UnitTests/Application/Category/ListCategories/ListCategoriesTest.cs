...
namespace Codeflix.Catalog.UnitTests.Application.ListCategories
{
    ...
    public class ListCategoriesTest
    {
        ...
        [Trait("Application", "ListCategories - Use Cases")]
        [MemberData(nameof(ListCategoriesTestDataGenerator.GetInputWithoutAllParameter), parameters:14, MemberType = typeof(ListCategoriesTestDataGenerator))]
